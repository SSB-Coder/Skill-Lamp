...
CREATE OR REPLACE FUNCTION campus_intelligence.gold.fn_readiness_score(
  cgpa DOUBLE,
...
-- Output: 98.0
-- SELECT campus_intelligence.gold.fn_readiness_score(9.5, 100.0, 100.0, 2, 0) AS test_1_score;
...
-- SELECT campus_intelligence.gold.fn_readiness_score(10.0, 100.0, 100.0, 4, 0) AS test_2_score;
...
-- SELECT campus_intelligence.gold.fn_readiness_score(7.5, 50.0, 0.0, 0, 2) AS test_3_score;
...
-- SELECT campus_intelligence.gold.fn_readiness_score(5.0, 0.0, 0.0, 0, 3) AS test_4_score;

-- Test Case 5: NULL safety test (All NULLs return 0.0)
-- SELECT campus_intelligence.gold.fn_readiness_score(NULL, NULL, NULL, NULL, NULL) AS test_5_score;
-- ============================================================================
